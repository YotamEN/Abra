...
from abra.errors import UnsupportedTopic, UnsupportedDataBaseError, UnsupportedMessageQueueError
...
class Saver:
    ...
    def save_feelings(self, data):
        ...
        self.db_handler.update_user_feelings(user_id=user_id, datetime=datetime, hunger=hunger, thirst=thirst,
                                             exhaustion=exh, happiness=happ, data_path=path, snapshot_id=snap_id)
